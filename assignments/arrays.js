...
// I should select the car by id because we know the car id is 33. Because what if we don't know the array [] index number? 
// I should use a for loop like above...example 2 with 'if' to select by id
